	...
	$(window).on('load', function() {
		...
		$(".preloader-wrapper").animate({
			...
			setTimeout(function(){
				...
				// About Giving Back to Community Parallax
				if($('.parallax-giving-back').length){
					$('.parallax-giving-back').parallax({
						imageSrc: 'assets/images/photos/parallax-giving-back.jpg',
						zIndex: '1'
					});
				}
